<?php
                ...
                if (isset($_SESSION['anmeldename']) && isset($_SESSION['pw'])) {
                    $_SESSION['Artikel'] = "Segitz Massageöl";
                    $_SESSION['Preis'] = "19,90 €";
...
<html class="wide wow-animation" lang="en">
        ...
        <div class="page">
            <div id="shop">
                ...
                <div class="article-container">
                    <img src="../images/shop/massageoel.jpeg" alt="Segitz Massageöl" class="article-image">
                    <h1 class="article-title">Segitz Massageöl</h1>
                    <p class="article-price">19,90 €</p>
                    ...
                    <p class="article-description">
                        <p>Tauchen Sie ein in die Welt der Entspannung mit unserem exklusiven Segitz-Therme Massageöl. Sorgfältig formuliert, um Ihre Sinne zu beleben und ein luxuriöses Wellness-Erlebnis zu schaffen, bietet dieses hochwertige Massageöl eine harmonische Fusion von reinen, natürlichen Inhaltsstoffen.</p>

                        <p>
                            Die leicht einziehbare Formel hinterlässt die Haut seidig glatt und pflegt sie intensiv. Die duftende Mischung aus beruhigendem Lavendel, erfrischender Minze und sanftem Mandelöl schafft eine Atmosphäre vollkommener Ruhe. Ob für eine entspannende Massage zu Hause oder als Ergänzung zu Ihrem Therme-Besuch – das Segitz-Therme Massageöl ist eine Verwöhnung für Körper und Geist.
                        </p></p>
    ...
    <h5>Eigenschaften:</h5>
        ...
        <li>Beruhigende Duftkomposition mit Lavendel und Minze</li>
        <li>Reich an pflegendem Mandelöl</li>
        <li>Leicht einziehende Formel für seidig glatte Haut</li>
        <li>Ideal für entspannende Massagen und Hautpflege</li>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <img class="responsive-image" src="../images/lageplan.jpg" alt="Lageplan">
                            </div>
                        </div>
                    </div>
                </div>
