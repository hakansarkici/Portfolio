<?php
                ...
                if (isset($_SESSION['anmeldename']) && isset($_SESSION['pw'])) {
                    $_SESSION['Artikel'] = "Ätherische Öle - 6 Stück";
                    $_SESSION['Preis'] = "14,90 €";
        ...
        <div class="page">
            <div id="shop">
                ...
                <div class="article-container">
                    <img src="../images/shop/athoele.jpeg" alt="Segitz Massageöl" class="article-image">
                    <h1 class="article-title">Ätherische Öle - 6 Stück</h1>
                    <p class="article-price">14,90 €</p>
                    ...
                    <p class="article-description">
                        <p>Entdecken Sie die Kraft der Natur mit dem Segitz-Therme Ätherische Öle Set – eine sorgfältig zusammengestellte Kollektion von sechs einzigartigen Düften, die Ihre Sinne beleben und eine harmonische Atmosphäre schaffen. Inspiriert von der Segitz-Therme, laden diese ätherischen Öle zu einer Reise der Entspannung und Erholung ein.</p>

                        <p>
                            Jedes Fläschchen enthält eine exquisite Mischung aus reinen und hochwertigen ätherischen Ölen, sorgfältig ausgewählt, um verschiedene Stimmungen zu unterstützen. Von beruhigendem Lavendel bis zu erfrischender Minze bietet dieses Set eine vielfältige Palette von Düften, perfekt für Aromatherapie, Massage oder einfach, um Ihr Zuhause in eine Oase der Ruhe zu verwandeln.</p>
                        
                    </div>
    <div class="article-container">
    <h5>Eigenschaften:</h5>
        
        <li>Set aus 6 einzigartigen ätherischen Ölen</li>
        <li>Hochwertige Mischungen für verschiedene Stimmungen
        </li>
        <li>Perfekt für Aromatherapie und Massage
        </li>
