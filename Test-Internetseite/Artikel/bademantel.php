<?php
                ...
                if (isset($_SESSION['anmeldename']) && isset($_SESSION['pw'])) {
                    ...
                    $_SESSION['Artikel'] = "Segitz Bademantel";
                    $_SESSION['Preis'] = "34,90 €";
        ...
        <div class="page">
            <div id="shop">
                ...
                <div class="article-container">
                    <img src="../images/shop/bademantel1.jpeg" alt="Segitz Massageöl" class="article-image">
                    <h1 class="article-title">Segitz Bademantel</h1>
                    <p class="article-price">34,90 €</p>
                    ...
                    <p class="article-description">
                        <p>Umhüllen Sie sich in Luxus und Komfort mit dem Martin-Segitz Bademantel, einer Hommage an höchsten Genuss und Wohlbefinden. Dieser exklusive Bademantel wurde sorgfältig gestaltet, um Ihnen ein Gefühl von Eleganz und Entspannung zu verleihen, inspiriert von der einzigartigen Atmosphäre der Martin-Segitz Therme.</p>

                        <p>    
                        Hergestellt aus hochwertigem Baumwollfrottee bietet dieser Bademantel ein sanftes, flauschiges Gefühl auf der Haut. Die großzügige Passform und der Gürtel ermöglichen eine individuelle Anpassung, während die stilvolle Gestaltung den zeitlosen Charme des Martin-Segitz Erlebnisses widerspiegelt.</p>
                        
                    </div>
    <div class="article-container">
    <h5>Eigenschaften:</h5>
        
        <li>Weicher Baumwollfrottee für ultimativen Komfort</li>
        <li>Großzügige Passform mit praktischem Gürtel</li>
        <li>Stilvolles Design inspiriert von der Martin-Segitz Therme</li>
        <li>Perfekt für gemütliche Momente zu Hause oder nach dem Wellness-Genuss</li>
