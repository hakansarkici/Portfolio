<?php
                if (isset($_SESSION['anmeldename']) && isset($_SESSION['pw'])) {
                    $_SESSION['Artikel'] = "Segitz Handtuch";
        ...
        <div class="page">
            <div id="shop">
                ...
                <div class="article-container">
                    <img src="../images/shop/handtuch1.jpeg" alt="Segitz Massageöl" class="article-image">
                    <h1 class="article-title">Segitz Handtuch</h1>
                    ...
                    <p class="article-description">
                        <p>Erleben Sie den Luxus von höchster Qualität mit dem Segitz-Therme Handtuch – ein unverzichtbares Accessoire, das Ihren Wellness-Moment perfekt abrundet. Dieses exklusive Handtuch wurde speziell für die Segitz-Therme entworfen und vereint Funktionalität mit einem Hauch von Eleganz.</p>

<p>Hergestellt aus hochsaugfähiger Baumwolle bietet das Segitz-Therme Handtuch nicht nur optimale Trocknungseigenschaften, sondern auch ein sanftes Berührungsgefühl auf der Haut. Das dezente Logo der Therme verleiht dem Handtuch eine subtile Eleganz, die den Charme der Segitz-Therme in Ihr Zuhause bringt.</p>
                        
                    </div>
    <div class="article-container">
    <h5>Eigenschaften:</h5>
        
        <li>Hochsaugfähige Baumwolle für schnelle Trocknung
        </li>
        <li>Weiches Berührungsgefühl für angenehmen Komfort
        </li>
        <li>Dezentes Segitz-Therme Logo für eine elegante Note
        </li>
        <li>Perfekte Ergänzung für Ihr persönliches Wellness-Erlebnis
        </li>
